...
import org.mybatis.jpetstore.wrapper.ICart;
import org.mybatis.jpetstore.wrapper.ICartImpl;
import org.mybatis.jpetstore.wrapper.ICartItem;
...
public class CartActionBean extends AbstractActionBean {
  ...
  private ICart cart = new ICartImpl();
  ...
  public Resolution addItemToCart() {
    if (cart.containsItemId(workingItemId)) {
      ...
      IItem item = catalogService.getItem(workingItemId);
  ...
  public Resolution removeItemFromCart() {
    IItem item = cart.removeItemById(workingItemId);
    if (item == null) {
  ...
  public Resolution updateCartQuantities() {
    ...
    Iterator<ICartItem> cartItems = getCart().getAllCartItems();
    while (cartItems.hasNext()) {
      ICartItem cartItem = cartItems.next();
