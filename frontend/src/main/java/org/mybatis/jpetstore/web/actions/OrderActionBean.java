...
import org.mybatis.jpetstore.wrapper.IOrder;
import org.mybatis.jpetstore.wrapper.IOrderImpl;
import org.mybatis.jpetstore.wrapper.IOrderService;
import org.mybatis.jpetstore.wrapper.IOrderServiceImpl;
...
public class OrderActionBean extends AbstractActionBean {
  ...
  // @SpringBean
  private transient IOrderService orderService = new IOrderServiceImpl();

  private IOrder order = new IOrderImpl();
